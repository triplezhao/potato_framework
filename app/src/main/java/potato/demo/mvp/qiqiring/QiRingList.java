...
interface QiRingList {
    ...
    interface C {
        ...
        void inject(QiRingListFragment fm);
    }
    ...
    interface V extends BaseView {
        ...
        void onRefreshSucc(QIRingEntity entity);

        void onRefreshFail(String err);

        void onLoadMoreSucc(QIRingEntity entity);

        void onLoadMoreFail(String err);

        void onCacheLoaded(QIRingEntity entity);
