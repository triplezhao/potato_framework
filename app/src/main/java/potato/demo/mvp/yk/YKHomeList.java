...
interface YKHomeList {
    ...
    interface C {
        ...
        void inject(YKHomeListFragment fm);
    }
    ...
    interface V extends BaseView {
        ...
        void onRefreshSucc(YKVideosByCategoryEntity entity);

        void onRefreshFail(String err);

        void onLoadMoreSucc(YKVideosByCategoryEntity entity);

        void onLoadMoreFail(String err);

        void onCacheLoaded(YKVideosByCategoryEntity entity);
    ...
    interface P extends BasePresenter {
        void reqRefresh(String category);

        void reqLoadMore(String category,String page);
    }
