...
<#if isFragment>
    ...
    * 2.activity会实现这个接口
    */
    interface V extends BaseEditView<${mvpClass}Bean, AiyouyunResultEntity> {

        void onSelectClerk(ClerkSelectEvent event);
    ...
    * 2.需要单独写类实现这个接口。
    */
    interface P extends BaseEditPresenter<${mvpClass}ParamBean> {
